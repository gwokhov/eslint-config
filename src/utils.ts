...
const isCwdInScope = isPackageExists('@gwokhou/eslint-config')
 ...
 * @example
 * ```ts
 * import { renameRules } from '@gwokhou/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@gwokhou/eslint-config'
